...
def show():
    ...
    with col_l:
        ...
        st.markdown('<p style="color:#64748b;font-size:0.85rem;margin-bottom:8px;">'
                    'Paste the job description for a personalized letter</p>',
                    unsafe_allow_html=True)
        jd = st.text_area("", height=280,
                           placeholder="Paste the full job description here...\n\nThe more detail you provide, "
                                       "the more tailored your cover letter will be.",
    ...
    with col_r:
                ...
                with st.spinner("✍️ Crafting your cover letter..."):
                    try:
                        ...
                        if res.status_code == 200:
                            ...
                            try: msg = res.json().get("detail", "Generation failed.")
        ...
        if cl:
            edited = st.text_area("Edit your cover letter below:",
                                   value=cl, height=280, key="cl_edit")
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            if history:
                ...
                st.markdown('<p style="color:#475569;">No previous cover letters.</p>',
                            unsafe_allow_html=True)
    except Exception:
        pass
